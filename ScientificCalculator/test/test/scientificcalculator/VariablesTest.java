...
public class VariablesTest {
    ...
    /**
     * Method to test the assignToVar method with more Complex numbers using 2
     * variables
     */
    @Test
    ...
    /**
     * Method to test the assignToVar method fail calling the
    ...
    /**
     * Method to test the copyFromVar method fail calling the
     * NullArgumentException (empty variable)
     */
    ...
    /**
     * Method to test the sumToVar method fail calling the
     * NoSuchElementException (empty stack)
     */
    @Test(expected = NoSuchElementException.class)
    ...
    /**
     * Method to test the sumToVar method fail calling the NullArgumentException
     * (empty variable)
     */
    @Test(expected = NullArgumentException.class)
    ...
    /**
     * Method to test the subtractToVar method using all the availables
     * variables
     */
    @Test
    ...
    /**
     * Method to test the subtractToVar method fail calling the
     * NoSuchElementException (empty stack)
     */
    @Test(expected = NoSuchElementException.class)
    ...
    /**
     * Method to test the saveVar and restoreVar methods using all the available
     * variables
     */
    @Test
